<div class="row">
				...
				<form class="form-horizontal" method="post" id="form_report" >
                    ...
                    <div class="row border-top justify-content-center">
                    	<div class="col-lg-3 mt-3">
                    		<button type="button" name="submit_report_payment3" id="submit_report_payment3" class="btn btn-info btn-block">ออกรายงาน</button>
                    	</div>
	...
	<div class="col-12" style="display: none;" id="showTable">
		<div class="card">
            <div class="card-body">
            	<iframe name="frame1" id="payment_ifr3" style="width:100%; height:1000px; border:0; border:none"></iframe>
