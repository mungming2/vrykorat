<div class="modal fade" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="paymentModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="width: 130%;">
            ...
            <form method="post" action="menu-miscellany/submitaddpayment.php">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <input type="checkbox" name="check_account_date" class="check_account_date" value="check_account_date">
                                    </div>
                                </div>
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="far fa-calendar-alt"></i></div>
                                </div>
                                <input type="text" name="account_date" class="form-control singledate account_date" disabled>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <input type="checkbox" name="check_cus_pay_date" class="check_cus_pay_date" value="check_cus_pay_date">
                                    </div>
                                </div>
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="far fa-calendar-alt"></i></div>
                                </div>
                                <input type="text" name="cus_pay_date" class="form-control singledate cus_pay_date" disabled>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <input type="checkbox" name="check_clear_date" class="check_clear_date" value="check_clear_date">
                                    </div>
                                </div>
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="far fa-calendar-alt"></i></div>
                                </div>
                                <input type="text" name="clear_date" class="form-control singledate clear_date" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                            ...
                            <div class="row p-3 border">
                                ...
                                <div class="col-4 my-2">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <input type="checkbox" name="check_installments_deadline_date" class="check_installments_deadline_date" value="check_installments_deadline_date">
                                            </div>
                                        </div>
                                        <div class="input-group-prepend">
                                            <div class="input-group-text"><i class="far fa-calendar-alt"></i></div>
                                        </div>
                                        <input type="text" name="installments_deadline_date"  class="form-control singledate installments_deadline_date" value="" autocomplete="off" disabled>
                                    </div>
                                </div>
                                <div class="col-4 my-2">
                                ...
                                <div class="col-4 my-2">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <input type="checkbox" name="check_pay_date" class="check_pay_date" value="check_pay_date">
                                            </div>
                                        </div>
                                        <div class="input-group-prepend">
                                            <div class="input-group-text"><i class="far fa-calendar-alt"></i></div>
                                        </div>
                                        <input type="text" name="installments_pay_date"  class="form-control singledate installments_pay_date" value="" autocomplete="off" disabled>
                                    </div>
                                </div>
                                <div class="col-4 my-2">
                                    <label>จำนวนเงิน</label>
