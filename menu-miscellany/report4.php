<div class="row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 mt-2">
			  				<div class="form-check form-check-inline">
							  	...
							  	<label class="form-check-label" for="type1">อุบัติเหตุและสุขภาพ /อื่น</label>
							</div>
							<div class="form-check form-check-inline">
							  	<input class="form-check-input" type="radio" name="type" id="type2" value="2">
							  	<label class="form-check-label" for="type2">เกี่ยวกับรถ</label>
							</div>
                        </div>
                    </div>
                    <div class="row border-top justify-content-center">
                    	<div class="col-lg-3 mt-3">
                    		<button type="button" name="submit_report_miscellany4" id="submit_report_miscellany4" class="btn btn-info btn-block">ออกรายงาน</button>
                    	</div>
	...
	<div class="col-12" style="display: none;" id="showTable1">
		<div class="card">
            <div class="card-body">
				<table id="report_miscellany41" class="table table-striped table-bordered nowrap" style="width:100%;">
	...
	<div class="col-12" style="display: none;" id="showTable2">
		<div class="card">
            <div class="card-body">
				<table id="report_miscellany42" class="table table-striped table-bordered nowrap" style="width:100%;">
