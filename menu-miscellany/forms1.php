...
<div class="card">
	<form method="post" action="menu-miscellany/submitforms1.php">
			...
			<div class="form-row">
	  		...
	  		<div class="form-row">
	  			<div class="form-group col-md-12">
					...
					<div class="form-check mb-3 ">
					  	<input class="form-check-input" type="radio" name="cus_type" value="1" id="cus_type1" checked>
					...
					<div class="form-check mb-3 ">
					  	<input class="form-check-input" type="radio" name="cus_type" value="0" id="cus_type2" >
