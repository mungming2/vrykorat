			...
			<div class="card-body">
				<form class="form-horizontal" method="post" id="form_report" >
					<div class="form-group row">
                        <label for="name" class="col-lg-4 text-lg-right control-label col-form-label">เลือกวันที่ทำกรรมธรรม์/วันที่รับแจ้ง</label>
                        <div class="col-lg-6">
                    ...
                    <div class="row border-top justify-content-center">
                    	<div class="col-lg-3 mt-3">
                    		<button type="button" name="submit_report_other3" id="submit_report_other3" class="btn btn-info btn-block">ออกรายงาน</button>
                    	</div>
