...
<form method="post" action="menu-miscellany/submitedit1.php">
    <div class="card">
	  	...
	  	<div class="card-body">
			...
			<div class="form-row">
				...
				<div class="form-group col-md-2">
			      	<label>ค่าคอมมิสชั่น</label>
			      	<div class="input-group">
				        <input type="text" name="commission" class="form-control" value="<?=$result_get_stock['commission'] ?>">
						<div class="input-group-prepend">
