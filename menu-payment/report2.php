<div class="row">
				...
				<form class="form-horizontal" method="post" id="form_report" >
                    ...
                    <div class="row border-top justify-content-center">
                    	<div class="col-lg-3 mt-3">
                    		<button type="button" name="submit_report_payment2" id="submit_report_payment2" class="btn btn-info btn-block">ออกรายงาน</button>
                    	</div>
	...
	<div class="col-12" style="display: none;" id="showTable">
		<div class="card">
            <div class="card-body">
				<table id="report_payment2" class="table table-striped table-bordered nowrap" style="width:100%">
					<thead>
						<tr>
							<th>ลำดับ</th>
							<th>เลขที่บิล</th>
