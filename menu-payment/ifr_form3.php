...
<body>
	...
	<iframe src="print_form3.php?search=<?=$search?>&select_date=<?=$date?>&type=<?=$type?>" name="frame1" style="width:0; height:0; border:0; border:none"></iframe>
